...
export default function CustomTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  style={{
    ...
    alignItems: "center",
    height: 70,
    backgroundColor: "#2c0f54", // ✅ Purple background here
          ...
          return (
            ...
            >
              <Ionicons
                name={iconName}
                size={24}
                color={isFocused ? "#ff0080" : "white"}
              />
              <Text style={{ color: isFocused ? "#ff0080" : "white", fontSize: 12 }}>
                {label}
              </Text>
            </TouchableOpacity>
          );
